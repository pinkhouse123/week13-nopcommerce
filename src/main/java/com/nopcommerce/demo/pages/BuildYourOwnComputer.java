...
public class BuildYourOwnComputer extends Utility {
    ...
    By selectSoftwareTwoOption = By.id("product_attribute_5_12");
    ...
    public void setSelectSoftwareTwoOption() {
        clickOnElement(selectSoftwareTwoOption);
    }
    ...
    public void mouseHooverandClickOnCart() {
