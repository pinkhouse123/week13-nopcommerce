...
public class Register extends Utility {
    ...
    By registerPageVerify =By.xpath("(//div[@class='result'])[1]");
    ...
    public void fillBasicFormAndSubmit(){
        sendTextToElement(firstName,"Umi");
        sendTextToElement(lastName,"Patel");
        sendTextToElement(email,"umipatel"+now.getSecond()+"@gmail.com");
        sendTextToElement(password,"umi23");
        sendTextToElement(ConfirmPassword,"umi123");
        clickOnElement(registerButton);

    }
    public String setVerifyCompleteRegisterPage() {
        return getTextFromElement(registerPageVerify);
    }
