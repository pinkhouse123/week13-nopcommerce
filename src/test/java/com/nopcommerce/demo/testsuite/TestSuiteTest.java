...
public class TestSuiteTest extends TestBase {
    ...
    public void verifyProductArrangeInAlphabeticalOrder(){
        ...
        desktopPage.selectByIndexFromDropDown("Name: Z to A");
    ...
    public void verifyProductAddedToShoppingCartSuccessFully()throws InterruptedException{
        ...
        buildYourOwnComputer.setSelectSoftwareOneOption();
        Thread.sleep(1000);
        buildYourOwnComputer.setSelectSoftwareTwoOption();
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        buildYourOwnComputer.mouseHooverandClickOnCart();
        ...
        Thread.sleep(1000);
        signInPage.setClickOnCheckOutAsGuest();
        Thread.sleep(1000);
